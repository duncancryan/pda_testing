...
# no __init__ function?
  ...
  dif highest_card(self, card1 card2) # missing colon AND should be def not dif
 ...
 def cards_total(cards): # should have self as first paramater if method being defined in class
